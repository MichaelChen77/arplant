...
/// </summary>
public class MarklessActivated1Script : MonoBehaviour 
{
	void Update()
	{
		...
		if (mobj1.GetComponent<MarklessActivated1Script> ().enabled == true) {
			mobj1.transform.Rotate (0, 1, 0);
		} else if (mobj2.GetComponent<MarklessActivated1Script> ().enabled == true) {
			mobj2.transform.Rotate (0, 0, 1);
		} else if (mobj3.GetComponent<MarklessActivated1Script> ().enabled == true){
